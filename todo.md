...
- [x] Recover the stopped development server and verify preview responsiveness.
- [x] Investigate and mitigate the repeated development-server stop caused by external Discord command-registration requests.
